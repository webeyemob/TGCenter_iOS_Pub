...
Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://github.com/webeyemob/TGCenter_iOS_Pub/raw/master/UdeskSDK/UdeskSDK_#{s.version}.zip" }
  s.platform     = :ios, '8.0'
  s.requires_arc = true
  ...
  s.subspec 'SDK' do |ss|
    ...
    ss.source_files = "UdeskSDK_#{s.version}/SDK/*.{h}"
    ss.vendored_libraries = "UdeskSDK_#{s.version}/SDK/libUdesk.a"
    ss.libraries    = 'z', 'xml2', 'resolv', 'sqlite3'
    ss.xcconfig     = {'OTHER_LDFLAGS' => '-ObjC',
                       'HEADER_SEARCH_PATHS' => '$(SDKROOT)/usr/include/libxml2'}
  end
  s.subspec 'UIKit' do |ss|
    ss.source_files = "UdeskSDK_#{s.version}/UDChatMessage/**/*.{h,m}"
    ss.resource     = "UdeskSDK_#{s.version}/UDChatMessage/UDResource/UdeskBundle.bundle"
    ss.dependency "UdeskSDK_#{s.version}/SDK"
  end
